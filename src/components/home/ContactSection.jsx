  ...
  return (
    <section id="contact" className="py-16 bg-gray-50">
      <div className="max-w-7xl mx-auto px-6">
        <SectionHeader
          title="Get In Touch"
          subtitle="Have questions or need assistance? We're here to help. Send us a message and we'll respond as soon as possible."
        />
        ...
        <div className="grid md:grid-cols-2 gap-12">
          ...
          <div className="space-y-8">
            <div>
              ...
              <p className="text-gray-600 mb-6">
                Feel free to reach out to us through any of these channels. Our team is available 24/7 to assist you.
              </p>
            </div>
          ...
          <div className="bg-white p-8 rounded-xl shadow-sm">
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                type="submit"
                className="w-full bg-primary-600 text-white py-3 rounded-lg font-semibold hover:bg-primary-700 hover:scale-[1.02] transition-all duration-200"
              >
                Send Message
              </button>
            </form>
